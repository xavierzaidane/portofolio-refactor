...
function StackSection() {
  return (
     <section id="stack" className="py-16 md:py-24 lg:py-32 bg-transparent border-t border-b border-white/10">
        <div className="px-4 sm:px-6 md:px-8 lg:px-12 flex flex-col md:flex-row justify-between gap-8 md:gap-12 mb-12 md:mb-16 lg:mb-20">
             <h2 className="text-xs sm:text-[13px] md:text-[15px] font-mono tracking-wide md:tracking-widest uppercase text-white/40">Stack</h2>
          <motion.div
              ...
              {STACK_DATA.map((item, idx) => {
                ...
                return (
                  <motion.div 
                    ...
                    className={`group flex flex-col items-center justify-center py-8 sm:py-12 md:py-16 lg:py-20 px-4 sm:px-6 md:px-8 transition-colors hover:bg-white/5 border-white/10
                  ...
                  >
                    ...
                    <span className="text-[10px] sm:text-[11px] md:text-[13px] font-mono tracking-wide md:tracking-widest uppercase text-white/20 group-hover:text-white/60 mt-4 sm:mt-6 md:mt-8 transition-colors pointer-events-none text-center">
                      {item.name}
                    </span>
                  </motion.div>
                );
