...
function WorkflowSection() {
  return (
     <section id="workflow" className="container mx-auto px-4 py-20  bg-transparent border-t border-foreground/10 dark:border-foreground/10">
        ...
        <div className="flex justify-between gap-6 md:gap-8 lg:gap-12 px-4 sm:px-5 md:px-8 lg:px-11">
          ...
          <motion.div 
            ...
            className="flex-1 max-w-5xl"
          >
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-px bg-foreground/20 dark:bg-white/10 border border-foreground/10 dark:border-white/5">
              {/* Development Group */}
              <motion.div 
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                <motion.h4 
                  ...
                  viewport={{ once: true, margin: "-100px" }}
                  className="text-[11px] sm:text-[13px] md:text-[15px] font-mono tracking-wide md:tracking-widest uppercase text-foreground/20 dark:text-white/20 mb-3 md:mb-4"
                >
                  Development
                </motion.h4>
              ...
              <motion.div 
                ...
                viewport={{ once: true, margin: "-100px" }}
                className="col-span-1 md:col-span-2 lg:col-span-3 bg-background dark:bg-background p-3 sm:p-4 md:p-6  border-foreground/10 dark:border-white/10 hidden lg:flex items-center justify-center"
              >
