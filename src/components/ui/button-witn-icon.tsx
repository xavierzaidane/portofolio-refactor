...
const ButtonWithIconDemo = () => {
  return (
    <Button className="relative h-12 w-fit cursor-pointer overflow-hidden rounded-full p-1 ps-6 pe-14 font-medium text-sm text-foreground/60 dark:text-white transition-all duration-500 hover:ps-14 hover:pe-6 group border border-border bg-background hover:border-foreground/20 dark:border-border dark:hover:border-foreground/30 hover:bg-accent">
