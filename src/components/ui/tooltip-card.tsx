      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className="pointer-events-none absolute z-50 min-w-[15rem] overflow-hidden rounded-md border border-transparent  shadow-sm ring-1 shadow-black/5 ring-black/5 bg-neutral-900 "
            style={{
              top: position.y,
              left: position.x,
            }}
