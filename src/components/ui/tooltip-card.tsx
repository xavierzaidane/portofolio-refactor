      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className="pointer-events-none absolute z-50 min-w-[15rem] overflow-hidden rounded-md border border-border shadow-sm ring-1 shadow-black/5 ring-black/5 bg-card"
            style={{
              top: position.y,
              left: position.x,
            }}
          >
            <div
              ref={contentRef}
              className="p-2 text-sm text-foreground/60 md:p-4"
            >
              {content}
            </div>
          </motion.div>
